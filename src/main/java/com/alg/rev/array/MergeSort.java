...
public class MergeSort extends RecursiveTask<int[]>
{
    ...
    {
        List<RecursiveTask> forkedTasks = new ArrayList<RecursiveTask>();
        ...
        if (arrayToDivide.length > 1)
        {
            ...
            MergeSort task1 = new MergeSort(partitionedArray.get(0));
            MergeSort task2 = new MergeSort(partitionedArray.get(1));
